...
@Client.on_message(filters.command("sb", PREFIXES))
async def sb(client: Client, m: Message):
    ...
    if not ccs:
        return await m.reply(
            "𝙂𝙖𝙩𝙚𝙬𝙖𝙮 <code>𝕤𝕖𝕓𝕒𝕤_𝟟𝕫 -» CA$39.99 ♻️</code>\n𝙁𝙤𝙧𝙢𝙖𝙩 -» <code>/sb cc|month|year|cvc</code>",
            quote=True,
        )
    ini = perf_counter()
    cc = ccs[0]
    ...
    status, status1 = await sebas(cc, mes, ano, cvv)
...
⸙ 𝙂𝙖𝙩𝙚𝙬𝙖𝙮 -» <code>𝕤𝕖𝕓𝕒𝕤_𝟟𝕫 -» CA$39.99</code>
